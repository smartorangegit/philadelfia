<?php  HeadAdd();?>
      ...
      <div class="container">
        ...
        <div class="main_values">
          <div class="box_404">
            ...
            <div class="info_404 message__info">
              <p>Пропонуємо переглянути інші проекти компанії SAGA Development</p>
              <div class="white_line"></div>
              <p class="not_exist school message__subheading">Пропонуємо переглянути інші проекти компанії SAGA Development</p>
            </div>



            <a class="link link_404" href="javascript:history.go(-1)" mce_href="javascript:history.go(-1)"><i class="icon-long-arrow-left"></i> НАЗАД</a>
            <a class="link link_404" href="<?UrlAdd()?>">НА ГОЛОВНУ <i class="icon-long-arrow-right"></i></a>
          </div>
        </div>
    ...
    .otherpages .footer_all{  margin-top: -40px;  z-index: 10;  position: relative;}
      @media only screen and (max-width:768px) {
        ...
        .link_404{  max-width: 136px;   font-size: 12px;   top: -10%;}
      }
