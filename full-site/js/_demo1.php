...
newurl.replace('//', '');
 newurl='/'+newurl;
			...
			var newurl='#'+ev.target.getAttribute('data-url');
			ga('send', { 'hitType': 'pageview', 'page':location.pathname+'home'});
			//	console.log(newurl +'   '+window.location.pathname)
				 if(newurl != window.location.hash){ console.log(window.location.hash);
