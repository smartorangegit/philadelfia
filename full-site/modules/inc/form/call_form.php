  <form class="form" action="" id='call_form'>
    <input type="text" onkeyup="javascript:countme('call_form');" name="name" value="" placeholder="Ім&prime;я *">
    ...
    <button class="link submit" data-id='call_form' type="submit" name="button">НАДІСЛАТИ <i class="icon-long-arrow-right"></i></button>
