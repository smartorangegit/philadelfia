...
$('#call_on').click(function(e){
  e.preventDefault(),
  $('.overlay').fadeIn(300),
  $('#callback1').css('display','block').animate({opacity: 1,top: '-6%'}, 200)
});
...
$('#call_price').click(function(e){
  e.preventDefault(),
  $('.overlay').fadeIn(300),
  $('#callprice').css('display','block').animate({opacity: 1,top: '-6%'}, 200)
});
...
$('#select-booking').click(function(e){
  e.preventDefault(),
  $('.overlay').fadeIn(300),
  $('#booking').css('display','block').animate({opacity: 1,top: '-6%'}, 200)
});
